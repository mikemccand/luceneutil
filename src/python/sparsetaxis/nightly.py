...
if os.system('python3 -u /l/util.nightly/src/python/sparsetaxis/runBenchmark.py -rootDir /l/sparseTaxis -logDir /l/logs.nightly/taxis/%4d.%02d.%02d.%02d.%02d.%02d -luceneMaster /l/sparseTaxis/sparseTaxis/lucene.master' % \
