...
run(
  "javac -d %s/build -cp core/build/classes/java/main:analysis/common/build/classes/java/main:analysis/kuromoji/build/classes/java/main %s/src/extra/perf/TestAnalyzerPerf.java"
  % (constants.BENCH_BASE_DIR, constants.BENCH_BASE_DIR)
)

print("  now run en perf")
run(
  "java -XX:+UseParallelGC -cp %s/build:core/build/classes/java/main:analysis/common/build/classes/java/main:analysis/kuromoji/build/classes/java/main perf.TestAnalyzerPerf /l/data/enwiki-20130102-lines.txt >> %s.tmp 2>&1"
  % (constants.BENCH_BASE_DIR, logFile)
)
...
print("  now run ja")
run(
  "java -XX:+UseParallelGC -cp %s/build:core/build/classes/java/main:analysis/common/build/classes/java/main:analysis/kuromoji/build/classes/java/main:analysis/kuromoji/src/resources perf.TestAnalyzerPerf /l/data/jawiki-20200620-lines.txt ja >> %s.tmp 2>&1"
  % (constants.BENCH_BASE_DIR, logFileJa)
)
