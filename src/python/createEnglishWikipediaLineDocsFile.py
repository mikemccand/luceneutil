...
# hmm what really is the difference!?
...
def main():
  ...
  if len(sys.argv) != 2:
    raise RuntimeError('Usage: python3.8 -u createEnglishWikipediaLineDocsFile.py /path/to/enwiki-20201201-lines.txt')
  ...
  if True:
    ...
    # ~13.08 GB
    print('big line file is %.2f GB' % to_gb(os.path.getsize(big_line_file_name)))
