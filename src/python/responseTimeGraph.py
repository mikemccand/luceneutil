...
logPoints = ((50, 2), (75, 4), (90, 10), (95, 20), (97.5, 40), (99, 100), (99.9, 1000), (99.99, 10000), (99.999, 100000), (99.9999, 1000000), (99.99999, 10000000))
...
def getPctPoints(fileName, name, warmupSec):
  if fileName not in pctPointsCache:
    ...
    print("%s: %d results (less %d = first %.1f seconds warmup); %.1f sec" % (name, len(results), upto, warmupSec, results[-1][0] - warmupSec))
