...
GLOVE_WORD_VECTORS_FILE = '%s/data/glove.6B.300d.txt' % BASE_DIR
GLOVE_VECTOR_DOCS_FILE = '%s/data/enwiki-20120502-lines-1k-300d.vec' % BASE_DIR
GLOVE_VECTOR8_DOCS_FILE = '%s/data/enwiki-20120502-lines-1k-300d-8bit.vec' % BASE_DIR
