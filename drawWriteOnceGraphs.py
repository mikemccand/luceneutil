...
def main():
  ...
  for i in xrange(1, len(arcs)+1):
    ...
    if i == 1:
      ...
      w('<a href="" onClick="if (event.shiftKey) {window.location=\'%s_%s.html\';} else {window.location=\'%s_%s.html\';} return false;"><img src=%s_%s.png></a>' % (i-1, nonce, i+1, nonce, i, nonce))
