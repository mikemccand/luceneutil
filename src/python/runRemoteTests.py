    ...
    while True:
      ...
      if command == "PRINT":
        ...
        if len(errors) != 0:
          ...
          for error in errors:
            s = s + "\n" + error
          if job in ("org.apache.solr.TestGroupingSearch", "org.apache.solr.TestDistributedGrouping") and s.find("Caused by: org.apache.lucene.util.ThreadInterruptedException") != -1:
            # OK
            pass
          else:
            msg(s)
