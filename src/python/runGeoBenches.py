...
with open(logFileName, 'w') as log:
  ...
  for shape in ('polyRussia', 'polyMedium', 'poly 10', 'nearest 10', 'sort', 'distance', 'box'):
    for approach in ('points', 'geo3d', 'shapes'):
      ...
      cmd = 'java -XX:+UseParallelGC -Xmx10g -cp %s:test-framework/build/classes/java/main:sandbox/build/classes/java/main:codecs/build/classes/java/main:codecs/build/resources/main:core/build/classes/java/main:core/build/resources/main:sandbox/build/classes/java/main:spatial3d/build/classes/java/main perf.IndexAndSearchOpenStreetMaps -%s -%s%s' % (utilSrcDir, approach2, shapeCmd, extra)
      print('RUN: %s' % cmd)
