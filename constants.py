...
WIKI_MEDIUM_TASKS_10MDOCS_FILE = '%s/wikimedium500.tasks' % BENCH_BASE_DIR
WIKI_MEDIUM_TASKS_1MDOCS_FILE = '%s/wikimedium500_1Mdocs.tasks' % BENCH_BASE_DIR
...
POSTINGS_FORMAT_DEFAULT='Lucene40'
