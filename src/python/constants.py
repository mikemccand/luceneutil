...
WIKI_VECTOR_TASKS_ARG_100D_BYTE_SCALED = f'{TASKS_DIR}/vector.task.txt,{TASKS_DIR}/vector-task-100d-scaled.vec,100'
WIKI_VECTOR_TASKS_ARG_300D_BYTE_SCALED = f'{TASKS_DIR}/vector.task.txt,{TASKS_DIR}/vector-task-300d-scaled.vec,300'
